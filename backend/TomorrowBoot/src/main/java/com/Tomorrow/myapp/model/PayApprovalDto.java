...
public class PayApprovalDto {
	...
	public PayApprovalDto(String aid, String tid, String cid, String sid, String partner_order_id,
			String partner_user_id, String payment_method_type, AmountDto amount, CardDto card_info, String item_name,
