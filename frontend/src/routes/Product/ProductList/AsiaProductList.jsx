...
import TopVisual from '../../../components/Product/TopVisual/TopVisualAsia';
...
const ProductList = () => {
    ...
    useEffect(() => {
        const fetchPosts = async () => {
            setLoading(true);
            const res = await axios.get('http://j4a305.p.ssafy.io/myapp/menu/gmbc', {
                params: {
                    keyword: '4'
                }
            });
                ...
                <div className="size">
                    <div className="bbs_tab">
                        <ul className="clear itemList5">
                            ...
                            <li><a href="/goods/4" className="on">동남아 밀키트<img src="/img/bbs_tab_arrow.png" /></a></li>
